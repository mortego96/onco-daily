...
export const topics = [
  ...
  //     'AND (cholangiocarcinoma[tiab] OR "biliary tract"[tiab] OR pancreatic[tiab])',
  // },
  // {
  //   id: "her2",
  ...
  //     'AND (biliary[tiab] OR cholangiocarcinoma[tiab] OR gallbladder[tiab] OR pancreatic[tiab] OR gastrointestinal[tiab])',
  // },
];

export const settings = {
  // Ventana de búsqueda: artículos AÑADIDOS a PubMed en los últimos N días.
  // 7 es un buen valor para una ejecución diaria con margen (evita huecos de fin de semana).
  daysBack: 7,
  ...
  // Tope total de tarjetas por ejecución (red de seguridad de coste).
  maxCards: 8,
  ...
  // Pon tu email real; ayuda si NCBI necesita contactarte por uso de la API.
  ncbiTool: "onco-daily",
